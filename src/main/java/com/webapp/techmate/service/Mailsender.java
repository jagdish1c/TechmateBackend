...
public class Mailsender {
    ...
    public void sendSimpleEmail(Contact contact) {
        ...
        message.setText("Dear "+contact.getFullname()+",\n\n"+
                "I hope this message finds you well. We want to express our sincere gratitude for connecting with Techmate. Your decision to engage with us is greatly appreciated, and we are excited about the potential collaboration ahead.\n\n"+
                "At Techmate, our core focus is on crafting exceptional software, applications, and websites that empower businesses and individuals to thrive in the digital age. We understand the critical role that technology plays in today's world, and we are committed to delivering innovative and customized solutions that meet your unique needs."+
                ...
                "Once again, thank you for choosing Techmate as your technology partner. We look forward to the opportunity to collaborate with you and contribute to your success.\n"+
                "Warm regards,\n"+"\n\n"+
                "Jagdish Chandra\n"+
                "Freelancer\n"+
                "TechMate: \n"+
